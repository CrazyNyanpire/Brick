...
import acetecsemi.com.brick.facade.impl.assembler.OAUserAssembler;
...
public class OAUserFacadeImpl implements OAUserFacade {
	...
	public List<OAUserDTO> findByCondition(OAUserDTO queryVo) {
		...
		StringBuilder jpql = new StringBuilder("SELECT USER_ID, USER_NAME, USER_ACCOUNTS, b.DEPT_ID, b.DEPT_NAME, a.EMAIL, a.MOBIL_NO,a.SEX ");
