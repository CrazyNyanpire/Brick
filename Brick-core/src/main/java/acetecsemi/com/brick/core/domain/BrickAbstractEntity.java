 ...
 */
@MappedSuperclass
public abstract class BrickAbstractEntity implements Entity {

    private static final long serialVersionUID = 8882145540383345037L;

    private static final Logger LOGGER = LoggerFactory.getLogger(BrickAbstractEntity.class);
    ...
    public static void setRepository(EntityRepository repository) {
        BrickAbstractEntity.repository = repository;
    }
