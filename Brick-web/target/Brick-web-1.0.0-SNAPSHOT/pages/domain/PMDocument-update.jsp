...
<form class="form-horizontal">
	...
	<input type="hidden" id="versionID" name="version" /> 
	           ...
	           <div class="form-group">
		           ...
		           <div class="form-group">
                    <label class="col-lg-3 control-label">fileUrl:</label>
	                    <div class="col-lg-9">
                           <input name="fileUrl" style="display:inline; width:94%;" class="form-control"  type="text"  id="fileUrlID" />
			    </div>
	</div>
		           <div class="form-group">
                    <label class="col-lg-3 control-label">uploadDate:</label>
	                 <div class="col-lg-9">
                    <div class="input-group date form_datetime" style="width:160px;float:left;" >
                        <input type="text" class="form-control" style="width:160px;" name="uploadDate" id="uploadDateID" >
                        <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                     </div>
			    </div>
	</div>
		           <div class="form-group">
                    <label class="col-lg-3 control-label">uploadUser:</label>
	                    <div class="col-lg-9">
                           <input name="uploadUser" style="display:inline; width:94%;" class="form-control"  type="text"  id="uploadUserID" />
			    </div>
	</div>
	</form>
