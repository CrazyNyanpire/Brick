...
<form class="form-horizontal">
	<input type="hidden" id="StatusIdID" name="statusId" value="61"/>
	<input type="hidden" id="StateID" name="state" value="已借机"/> 
...
$.ajax({
	async:false,
	url: '${pageContext.request.contextPath}/Category/get/61.koala',
	type: 'POST',
	dataType: 'json',
})
.done(function(msg) {
	...
	selectItems['subStatusIdID'] = contents;
});
var contents = [{title:'请选择', value: ''}];
