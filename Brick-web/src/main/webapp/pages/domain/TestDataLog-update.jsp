...
<form class="form-horizontal">
	...
	<input type="hidden" id="versionID" name="version" /> 
	           ...
	           <div class="form-group">
		           ...
		           <div class="form-group">
                    <label class="col-lg-3 control-label">equipmentNo:</label>
	                    <div class="col-lg-9">
		           ...
		           <div class="form-group">
                    <label class="col-lg-3 control-label">ip:</label>
	                    <div class="col-lg-9">
                           <input name="ip" style="display:inline; width:94%;" class="form-control"  type="text"  id="ipID" />
			    </div>
	</div>
		           <div class="form-group">
                    <label class="col-lg-3 control-label">acetecLot:</label>
	                    <div class="col-lg-9">
                           <input name="acetecLot" style="display:inline; width:94%;" class="form-control"  type="text"  id="acetecLotID" />
			    </div>
	</div>
		           <div class="form-group">
                    <label class="col-lg-3 control-label">customerNo:</label>
	                    <div class="col-lg-9">
                           <input name="customerNo" style="display:inline; width:94%;" class="form-control"  type="text"  id="customerNoID" />
			    </div>
	</div>
		           <div class="form-group">
