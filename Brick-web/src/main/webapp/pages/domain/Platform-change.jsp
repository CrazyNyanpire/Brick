...
<input  name="webSign" type="hidden"  value="1"/>
<input type="hidden" id="versionID" name="version" /> 
	...
	<div class="prvShow">
                    ...
                    <label class="col-lg-2 col-sm-2 control-label">当前测试数:</label>
	                    <div class="col-lg-10 col-sm-10">
                           <input name="testQty" style="display:inline; width:94%;" class="form-control"  type="text"  id="testQtyID" dataType="Require"/>
                           <span class="required">*</span>
			    </div>
	</div>
                    ...
                    <label class="col-lg-2 col-sm-2 control-label">片选:</label>
                     <div class="col-lg-10 col-sm-10">
                     	<input name="waferTD"  type="hidden"  id="waferTDID" />
	...
	<div class="nextShow">
			    ...
			    <div class="form-group part_FT">
                    <label class="col-lg-2 col-sm-2 control-label">Kits:</label>
	                    <div class="col-lg-10 col-sm-10">
	                    <div class="btn-group select" id="KitsID"></div>
                           <input name="kitsId"  type="hidden"  id="KitsID_" />
			    </div>
			    </div>
			    <div class="form-group part_FT">
                    <label class="col-lg-2 col-sm-2 control-label">LoadBoard:</label>
	                    <div class="col-lg-10 col-sm-10">
	                    <div class="btn-group select" id="loadBoardID"></div>
                           <input name="loadBoardId"  type="hidden"  id="loadBoardID_" />
			    </div>
	</div>
	</div>
	</form>
